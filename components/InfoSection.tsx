...
export const InfoSection = ({ title, description, icon: Icon, gradient, isReversed = false }: InfoSectionProps) => {
  return (
    <section className="py-24 border-b border-white/10">
      <div className={`container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center ${isReversed ? 'direction-rtl' : ''}`}>
        <motion.div
